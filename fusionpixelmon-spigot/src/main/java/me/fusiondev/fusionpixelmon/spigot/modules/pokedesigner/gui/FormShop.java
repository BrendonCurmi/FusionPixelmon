...
//        Pokemon pokemon1 = pokemon;
        ...
        for (IEnumForm form : forms) {
            ...
            InvItem item1 = new InvItem(SpigotAdapter.adapt(PixelmonAPI.getPokeSprite(pokemon)), (pokemon.isShiny() ? "§3Shiny " : "§3") + pokemon.getSpecies().getPokemonName() + " §8(§e" + form.getLocalizedName() + "§8)");
