...
public class InvInventory {
     ...
     * of the instantiated object, using {@link #openPage(Player, String)}. If you
    ...
    public void openPage(Player player, String id) {
        openPage(player, states.get(id));
    }

    public void openPage(Player player, InvPage page) {
     ...
     */
    public static InvPage getPlayerOpened(Player player) {
     ...
     * call {@link #playerClosed(Player)} before this again as this method
     ...
     */
    public static void playerOpened(Player player, InvPage invPage) {
     ...
     */
    public static void playerClosed(Player player) {
